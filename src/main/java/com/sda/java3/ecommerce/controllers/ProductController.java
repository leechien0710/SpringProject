...
public class ProductController extends BaseController {
  ...
  public String filterProducts(@ModelAttribute ProductListFilter filter, ModelMap model) {
    ...
    model.addAttribute(
        "breadcrumbs",
        Arrays.asList(Breadcrumb.builder().name("Home").url("/").last(true).build()));
  ...
  public String productDetail(@PathVariable String id, ModelMap modelMap, Model model) {
    initModelMap(modelMap);
    ...
    modelMap.addAttribute(
        ...
        Arrays.asList(
            ...
            Breadcrumb.builder()
                ...
                .last(true)
                .url(String.format("/product-detail/%s", id))
                .build()));
